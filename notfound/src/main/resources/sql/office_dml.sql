...
INSERT INTO tbl_payment (reservation_code, member_code, payment_date, payment_method, payment_amount, payment_status)
VALUES
    (1, 1, '2025-03-15 07:50:00', '카드', 500000, '결제완료'),   -- 예약 1번 (회원 1번)
    (2, 2, '2025-03-18 09:50:00', '계좌이체', 4000000, '결제완료'), -- 예약 2번 (회원 2번)
    (3, 3, '2025-03-20 11:50:00', '카드', 2100000, '결제완료'),   -- 예약 3번 (회원 3번)
    (5, 4, '2025-03-22 17:50:00', '카드', 4500000, '결제완료'),   -- 예약 5번 (회원 4번)
    (6, 1, '2025-03-25 15:50:00', '계좌이체', 500000, '결제취소'), -- 예약 6번 (회원 1번, 취소)
    (7, 2, '2025-03-27 11:50:00', '카드', 6050000, '결제완료'),   -- 예약 7번 (회원 2번)
    (10, 4, '2025-04-01 07:50:00', '계좌이체', 1500000, '결제완료'), -- 예약 10번 (회원 4번)
    (11, 3, '2025-04-05 09:50:00', '카드', 2000000, '결제취소');  -- 예약 11번 (회원 3번, 취소)
