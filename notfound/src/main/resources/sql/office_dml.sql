...
VALUES
    ...
    (5, '4인실', '501', 100, 'http://www.dodreamoffice.com/img/why_img1.jpg'),
    (5, '1인실', '502', 500, 'http://www.dodreamoffice.com/img/why_img1.jpg'),
...
VALUES
    ...
    (2, 4, '2025-03-18 10:00:00', '2025-03-18 12:00:00', 100, '예약완료'),
    (3, 6, '2025-03-20 12:00:00', '2025-03-20 14:00:00', 16000000, '예약완료'),
    (3, 9, '2025-03-20 14:00:00', '2025-03-20 16:00:00', 500, '예약완료'),
    (4, 7, '2025-03-22 18:00:00', '2025-03-22 20:00:00', 20, '예약완료'),
    (1, 3, '2025-03-25 16:00:00', '2025-03-25 18:00:00', 500000, '예약취소'),
    (2, 10, '2025-03-27 12:00:00', '2025-03-27 14:00:00', 40, '예약완료'),
    (2, 12, '2025-03-27 14:00:00', '2025-03-27 16:00:00', 50, '예약완료'),
...
VALUES
    (1, '2025-03-15 07:50:00', '카드', 500000, '결제완료', 'IMP123456', 'ORD123456'),
...
INSERT INTO tbl_faq (faq_title, faq_content) VALUES
 ...
 안전한 비대면 전자계약 플랫폼을 통해 계약이 이루어집니다. '),
                                                 ...
                                                 ('택배서비스는 어떻게 이용하고 요금은요?', '대표님 자택 또는 사업장에서 패킹 및 송장스티커를 붙여서 건물 앞에 드롭하시면 되고 요금은 익월 정산합니다.\n
픽업은 평일 주 5일 오후에 택배사에서 진행합니다. 택배요금은 소형(세변의합 80CM 이내) 기준 2,120원(VAT포함)입니다.'),
                                                 ('제가 양초를 만드는 공방을 하는데요. 작업을 해도 되나요?', '404 OFFICE NOT FOUND는 공유공방이 아닌 사무공간입니다. \n죄송하지만 냄새, 소음등의 이유로 공방의 상주사무실 입점은 어렵습니다.'),
