...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer(){
        ...
        return web -> web.ignoring()
                ...
                .requestMatchers("/css/**", "/js/**", "/img/**"); // 추가 경로 허용
    }
    ...
    public SecurityFilterChain filterChainConfigure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers("/auth/login","/member/signup","/main", "/", "/member/check-duplicate", "/member/find-id",
                    "/member/reset-password", "/company/introduce", "/company/ceo", "/store/storelist",   "/faq/list",
                    "/event/list", "/store/detailstore/*", "/event/detail/**").permitAll();
